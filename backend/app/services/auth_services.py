...
# from app.models.visamodels import PasswordResetToken, Role, User, UserLoginHistory, UserProfile, UserRole
...
# from app.services.services import _store_refresh_token, _verify_provider_token, db_create, db_get_by_field, db_get_by_id, db_update, get_user_profile, get_user_role, utc_now
...
async def service_signup(
    ...
    *,
    ...
    return {
        ...
        "refresh_token":   refresh_token,
        "roles":           roles,
        "profile_picture": None,           # no picture yet at signup
        "user": {
            "first_name": user.first_name,
            "last_name":  user.last_name,
            "email":      user.email,
